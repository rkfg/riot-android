...
public class VectorSettingsPreferencesFragment extends PreferenceFragment implements SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private void addButtons() {
        Drawable addIcon = ThemeUtils.getDrawable(getActivity(), R.attr.vector_add_icon);
        ...
        addEmailPreference.setIcon(addIcon);
        ...
        addPhoneNumberPreference.setIcon(addIcon);
    ...
    private void setUserInterfacePreferences() {
        ...
        selectedLangaguePreference.setSummary(VectorAppRkfgBeta.localeToString(VectorAppRkfgBeta.getApplicationLocale(getActivity())));
